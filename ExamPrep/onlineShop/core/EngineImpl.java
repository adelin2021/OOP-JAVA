...
public class EngineImpl implements Engine {
    ...
    private String processInput() throws IOException {
        ...
        switch (command) {
            case AddComputer:
                return this.controller.addComputer(data[0],
                        Integer.parseInt(data[1]), data[2], data[3],
                        Double.parseDouble(data[4]));
            case AddPeripheral:
                return this.controller.addPeripheral(Integer.parseInt(data[0]),
            ...
            case AddComponent:
                return this.controller.addComponent(Integer.parseInt(data[0]),
                        Integer.parseInt(data[1]), data[2], data[3], data[4],
                        Double.parseDouble(data[5]),
